                                ...
                                <div class="form-group"> 
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" pattern="[0-9]{10}"  title="Please enter 10 digits"  id="company" placeholder="" class="form-control" name="Contact1"  required >
                                        </div></div><br>  
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text"   pattern="[0-9]{10}"  title="Please enter 10 digits"  id="company" placeholder="" class="form-control" name="Contact2" >
                                            </div></div></div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="url" id="street" placeholder="" class="form-control" name="CompanyWebsite"></div>
                                    </div></div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text"  pattern="[0-9]+"  title="Please enter  digits only" id="registration no" placeholder="" class="form-control" name="RegistrationNo"></div>
                                        <div class="col-lg-6">
                                            <label for="Bank Name" class=" form-control-label">Bank Name</label>
                                            <input type="text" pattern="[a-zA-Z]+"  title="Please enter  alphabets only" id="bank name" placeholder="" class="form-control" name="BankName"></div>
                                    </div></div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label for="GST No" class=" form-control-label">GST  No</label>
                                            <input type="text" pattern="[a-zA-Z0-9]{15}" title="Please enter valid GST.no"  id="gst no" placeholder="" class="form-control" name="GSTno"></div>
                                        <div class="col-lg-6">
                                            <label for="Account NO" class=" form-control-label">Account No</label>
                                            <input type="text"   pattern="[0-9]+"  title="Please enter  digits only" id="account no" placeholder="" class="form-control" name="Accountno"></div>
                                    </div></div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" pattern="[a-zA-Z0-9]{10}" title="Please enter valid PAN number" id="PAN No" placeholder="" class="form-control" name="PANno"></div> 
                                        <div class="col-lg-6">
                                            <label for="IFSC Code" class=" form-control-label">IFSC Code</label>
                                            <input type="text" pattern="[a-zA-Z0-9]{11}" title="Please enter valid IFCS code" id="account no" placeholder="" class="form-control" name="IFSCcode"></div>
                                    </div></div>  
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text"  pattern="[0-9]+" title="Please enter  digits only" id="PAN No" placeholder="" class="form-control" name="StartFinancialyear"></div> 
                                        <div class="col-lg-6">
                                            <label for="IFSC Code" class=" form-control-label">To financial year</label>
                                            <input type="text"   pattern="[0-9]+" title="Please enter  digits only"  id="account no" placeholder="" class="form-control" name="EndFinancialyear"></div>
                                    </div></div>                   
           ...
           <div class="row">
            <div class="col-sm-6">
                 <div class="form-group"> 
                                        ...
                                        <div class="form-group"> 
                                            <label for="company" class=" form-control-label">Contact no.1</label>
                                            <input type="text"  pattern="[0-9]{10}"  title="Please enter 10 digits"  id="company" placeholder="" class="form-control" name="Contact1" maxlength="10" value="<%=rs.getString("Contact1") %>">
                                        </div></div>
                                        </div> 
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="company" class=" form-control-label">Contact no.2</label>
                                                <input type="text"  pattern="[0-9]{10}"  title="Please enter 10 digits"  id="company" placeholder="" class="form-control" name="Contact2" maxlength="10" value="<%=rs.getString("Contact2") %>">
                                            </div></div></div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="street" class=" form-control-label">Postal Code</label>
                                                <input type="text" pattern="[0-9]+"  title="Please enter  digits only" id="street" placeholder="" class="form-control" name="Postalcode" value="<%=rs.getString("Postalcode") %>"></div>
                                        </div></div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label for="company website" class=" form-control-label">Company Website</label>
                                            <input type="url" id="street" placeholder="" class="form-control" name="CompanyWebsite" value="<%=rs.getString("CompanyWebsite") %>"></div>
                                    </div></div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="Registration no" class=" form-control-label">Registration no</label>
                                            <input type="text" pattern="[0-9]+"  title="Please enter  digits only"  id="registration no" placeholder="" class="form-control" name="RegistrationNo" value="<%=rs.getString("RegistrationNo") %>"></div>
                                        <div class="col-md-6">
                                            <label for="Bank Name" class=" form-control-label">Bank Name</label>
                                            <input type="text" pattern="[a-zA-Z]+"  title="Please enter alphabets only" id="bank name"  class="form-control" name="BankName" value="<%=rs.getString("BankName") %>"></div>
                                    </div></div>
                                      <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="GST No" class=" form-control-label">GST No</label>
                                            <input type="text"  pattern="[a-zA-Z0-9]{15}" title="Please enter valid GST.no"  id="registration no" placeholder="" class="form-control" name="GSTno" value="<%=rs.getString("GSTno") %>"></div>
                                        <div class="col-md-6">
                                            <label for="Account No" class=" form-control-label">Account No</label>
                                            <input type="text" pattern="[0-9]+" title="Please enter digits only" id="bank name"  class="form-control" name="Accountno" value="<%=rs.getString("Accountno") %>"></div>
                                    </div></div>
                                      <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="PAN No" class=" form-control-label">PAN No</label>
                                            <input type="text"  pattern="[a-zA-Z0-9]{10}" title="Please enter valid PAN number" id="registration no" placeholder="" class="form-control" name="PANno" value="<%=rs.getString("PANno") %>"></div>
                                        <div class="col-md-6">
                                            <label for="IFSC Code" class=" form-control-label">IFSC Code</label>
                                            <input type="text"  pattern="[a-zA-Z0-9]{11}" title="Please enter valid IFSC code"  id="bank name"  class="form-control" name="IFSCcode" value="<%=rs.getString("IFSCcode") %>"></div>
                                    </div></div>
                                     <div class="row">
                                        <div class="col-md-6">
                                            <label for="StartFinancialyeaR" class=" form-control-label">StartFinancialyear</label>
                                            <input type="text"  pattern="[0-9]+" title="Please enter digits only" id="registration no" placeholder="" class="form-control" name="StartFinancialyear" value="<%=rs.getString("StartFinancialyear") %>"></div>
                                        <div class="col-md-6">
                                            <label for="EndFinancialyear" class=" form-control-label">EndFinancialyear</label>
                                            <input type="text"  pattern="[0-9]+" title="Please enter digits only" id="bank name"  class="form-control" name="EndFinancialyear" value="<%=rs.getString("EndFinancialyear") %>"></div>
                                    </div></div>
