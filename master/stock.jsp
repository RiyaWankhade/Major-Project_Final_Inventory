...
<div class="wrapper">
          ...
          <!-- left column -->
           <div class="col-lg-12">
                        <div class="card card-primary">
                            <div class="card-header"><strong>Stock</strong><strong> Details</strong>
				...
				<!-- End Struts Validation -->
                            ...
                            <div class="card-body card-block">
                                <div id="addNewForm">
                                 <form role="form" action="stockInsert" method="post">
 ...
 <%
                                                                                           ...
                                                                                           String sql12 = "select * from vendor";
                                                                                           ResultSet rs12= smt12.executeQuery(sql12);
                                                                                           while(rs12.next()){   %>
                                 
                                                                                        	   <option value="<%=rs12.getString("Company")%>"><%=rs12.getString("Company")%></option>
 ...
 <%
                                        ...
                                        <div class="row">    
                                                ...
                                                <div class="col-lg-6">
                                                <label for="Country" class=" form-control-label">Cost of Product (in Rs)</label>
                                                 <input type="text" pattern="[0-9]+" title="Please enter proper price" id="company" placeholder="" class="form-control" name="cost">
                                                
                                                                                 </div>                        
                            <%--  <div class="col-lg-6">
                                                <label for="city" class=" form-control-label">Instock</label>
 ...
 <%
                                                                                           ...
                                                                                           String sql13 = "select * from product where Product from stock==Name from product";
                                                                                           ResultSet rs13= smt13.executeQuery(sql13);
                                                                                           while(rs13.next())
                                                                                           { %>
                                                                                        	   <option value="<%=rs13.getString("Quantity")%>"><%=rs13.getString("Quantity")%></option>
                                                                       ...
                                                                       <div class="col-lg-6">
                                                <label for="company" class=" form-control-label">Purchase Tax (in %)</label>
...
<br>
                 ...
                 try{
                        		...
                        		String sq="select * from stock where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="hidden" value="<%=id1%>" name="stockId">
 ...
 <%
                                        ...
                                        <div class="form-group"> 
                                            <label for="company" class=" form-control-label">Purchase Tax(in %)</label>
                                            <input type="text" pattern="[0-9]+" title="Please enter digits only"  id="company" placeholder="" class="form-control" name="date" value="<%=rs.getString("PurchaseTax") %>">
                                        </div></div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-bordered table style="width:100%">
                                        ...
                                        <%
                                                                                           ...
                                                                                           String sql11 = "select * from stock";
                                                                                           ...
                                                                                           while(rs11.next()){                                  		
                                                                                               ...
                                                                                               <tr>
                                                                                                                                                 ...
                                                                                                                                                 <td id="cost_<%rs11.getString("id");%>"><%=rs11.getString("cost") %></td>
                                                                                                                                                   <td> 
                                                                                                                                                     <a href="stock?id=<%=rs11.getString("id")%>" class="btn btn-success btn-sm">Update</a>  </td>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title" style="text-align: right">Delete Under Stock</h4>
		        </div>
		        <form action="stockDelete" method="POST">
		        <div class="modal-body">
		          
		          
		          	<input type="hidden" id="stockId_d" name="stockId">
