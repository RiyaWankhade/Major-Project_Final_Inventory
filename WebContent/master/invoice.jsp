...
<address>
                                                                                              ...
                                                                                              <p> <%=rs.getString("Company") %></p>
                                                                                                ...
                                                                                                <p> <%=rs.getString("Contact1") %></p>
                                                                                        <%--   <p><%=rs.getString("Contact2") %></p> --%>
		...
		<article>
			...
			<h3><address ></h3>
			 <%
                                                                                           ...
                                                                                           String sql11 = "select * from sales where id='"+id1+"'";
                                                                                           ResultSet rs11= smt11.executeQuery(sql11);
                                                                                           while(rs11.next()){                                  		

                                                                                               %>
				<p><%=rs11.getString("FirstName")%>&nbsp;<%=rs11.getString("LastName") %></p>
				 <%
                       i11++;
                                                                                           }  //end of while
			...
			<table class="inventory">
				<thead>
					...
					<th><span >Product</span></th>
						...
						<th><span >Unit Price (in Rs)</span></th>
