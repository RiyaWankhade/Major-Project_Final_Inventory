...
<div class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
                        <div class="card card-primary">
                            <div class="card-header"><strong>Attendance</strong><strong> Form</strong>
				...
				<!-- End Struts Validation -->
                            ...
                            <div class="card-body card-block">
                                <div id="addNewForm">
                                 <form role="form" action="attendanceInsert" method="post">
 ...
 <%
                                                                                           ...
                                                                                           String sql12 = "select * from employee";
                                                                                           ResultSet rs12= smt12.executeQuery(sql12);
                                                                                           while(rs12.next()){   %>
                                                                                        	   <option value="<%=rs12.getString("FirstName")%>"><%=rs12.getString("FirstName")%></option>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="date" id="company" placeholder="" class="form-control" name="date" required>
                                        </div></div></div>           
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label for="company address" class=" form-control-label">Attendance</label>
                                ...
                                <option value="Absent">Absent</option>
                                 <option value="Half-day">Half-day</option>
                                            ...
                                            <div class="col-lg-6">
                                                <label for="company" class=" form-control-label">In-Time</label>
                                                <input type="time" id="company" placeholder="" class="form-control" name="intime">
                                            </div></div></div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label for="Country" class=" form-control-label">Out-Time</label>                
                                                <input type="time" id="vat" placeholder="" class="form-control" name="outtime"></div>
                                          <div class="col-lg-6">
                                                <label for="company" class=" form-control-label">OverTime</label>
                                                <input type="text" id="company" placeholder="" class="form-control" name="overtime">
                                            </div></div></div>
                 ...
                 try{
                        		...
                        		String sql="select * from attendance where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="hidden" value="<%=id1%>" name="attId">
 ...
 <%
                                        ...
                                        <div class="form-group"> 
                                            <label for="company" class=" form-control-label">Date</label>
                                            <input type="date" id="company" placeholder="" class="form-control" name="date" value="<%=rs.getString("date") %>">
                                        </div></div>
                                        </div> 
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="company address" class=" form-control-label">Attendance</label>  
                                                 ...
                                                 <select class="form-control" name="attendance">
                                                  <option value="<%=rs.getString("attendance") %>"><%=rs.getString("attendance") %></option>
                                <option value="">------------Select ------------</option>
                                <option value="Present">Present</option>
                                <option value="Absent">Absent</option>
                                 <option value="Half-day">Half-day</option>
                                            ...
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="company" class=" form-control-label">In-Time</label>
                                                <input type="time" id="company" placeholder="" class="form-control" name="intime" value="<%=rs.getString("intime") %>">
                                            </div></div></div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="Country" class=" form-control-label">Out-Time</label>                
                                                <input type="time" id="vat" placeholder="" class="form-control" name="outtime" value="<%=rs.getString("outtime") %>"></div>
                                                 <div class="col-md-6">
                                            <label for="Country" class=" form-control-label">Over-Time</label>                
                                                <input type="text" id="vat" placeholder="" class="form-control" name="overtime" value="<%=rs.getString("overtime") %>"></div>
                                            </div></div>
                                         ...
                                         <%
                                            ...
                                            <tr>
                                                                                              ...
                                                                                              <td id="overtime_<%rs.getString("id");%>"><%=rs.getString("overtime") %></td>
                                                                                               ...
                                                                                               <td>     <a href="attendance?id=<%=rs.getString("id")%>"class="btn btn-success btn-sm" >Update</a>  </td>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title" style="text-align: right">Delete Under Attendance</h4>
		        </div>
		        <form action="attendanceDelete" method="POST">
		        <div class="modal-body">
		          
		          
		          	<input type="hidden" id="attId_d" name="attId">
