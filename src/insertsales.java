...
try{
    ...
    while(rs13.next())
    { 
 	i1= Integer.parseInt(  rs13.getString("Quantity"));
 	id1= Integer.parseInt(  rs13.getString("Id"));
}
...
try  {
	...
	PreparedStatement pst = con1.prepareStatement(query);
	 ...
	 pst.executeUpdate();
     	...
     	System.out.println("Sql..........."+query);
     							try {
     									...
     									PreparedStatement pst1=con1.prepareStatement(query1);
     									  pst1.setInt(1,total );
											/*
											 * pst1.setString(2,cost); pst1.setString(3, "PurchaseTax");
											 */
	  ...
	  request.getSession().setAttribute("successmsg", "Order Created Successfully");
